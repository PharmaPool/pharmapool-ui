    ...
    <>
      ...
      <div className="about">
        ...
        <p>
          ...
          cost-effective connections, Pharmapool is dedicated to revolutionizing
          the way pharmacies and pharmacists engage in commerce. We strive to
          enhance accessibility, streamline operations, and promote unity within
        ...
        <div className="services">
          <div className="service">
            ...
            <p>
              ...
              that pharmacies can access the medications they need to serve
          ...
          <div className="service">
            ...
            <p>
              Pharmapool's Sales at Discount service enables users to sell
              excess pharmaceutical products at discounted prices. Whether you
              have surplus stock or are looking for cost-effective supplies, our
              platform connects buyers and sellers, promoting sustainable
              business practices and reducing waste.
            </p>
          </div>
        </div>
